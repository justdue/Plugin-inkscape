#!/usr/bin/env python 
"""
Modified by Luiz Carlos Pinage 2016, Due, duelaser.com 
...
class laser_gcode(inkex.Effect):
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("-f", "--filename",                        action="store", type="string",          dest="file",                                default="due.gcode",                 help="File name")            
        ...
        self.OptionParser.add_option("",   "--laser-power",                     action="store", type="int",             dest="laser_power",                         default="100",                          help="Laser power (%)")
...
################################################################################
    def effect(self) :
        ...
        self.tools = {
            ...
            "gcode before path": ("G4 P0 \n" + self.options.laser_command + " S" + str(int(self.options.laser_power * 2.55)) + "\nG4 P" + self.options.power_delay),
